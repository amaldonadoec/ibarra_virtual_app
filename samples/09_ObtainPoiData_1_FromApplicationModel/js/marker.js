...
function Marker(poiData) {
    ...
    */
    ...
    this.imageBackground = new AR.ImageDrawable(
    new AR.ImageResource("assets/signs.png",
     {
    ...
    this.descriptionLabel = new AR.Label(poiData.title, 0.6, {
        zOrder: 1,
        translate: {
            y: -1.50
        },
    ...
    */
    this.markerObject = new AR.GeoObject(markerLocation, {
        drawables: {
            cam: [ this.descriptionLabel, this.imageBackground],
